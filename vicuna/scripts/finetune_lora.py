...
class LoadArguments:
    ...
    base_model_type: str = field(default="alpaca")
...
def main():
    ...
    finetune_args, training_args = HfArgumentParser(
        (LoadArguments, LoraArguments, TrainingArguments)
    ).parse_args_into_dataclasses()

    # init model
    model = AutoModel.from_pretrained(
        finetune_args.base_model, load_in_8bit=True, trust_remote_code=True, device_map="auto"
    )
